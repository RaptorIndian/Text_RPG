...
class Consumable:
    ...
    def __init__(self, name: str, description: str, amount: int, price: int):
        self.name = name
...
class Food:
    def __init__(self, name: str, description: str,  weight: int, amount: int, hp_increase: int, price: int):
        self.name = name
        self.description = description
        self.weight = weight
        self.amount = amount
